...
export const PasswordInput = ({
  ...
  return (
    <View style={tailwind`${customCss}`}>
      <Text style={tailwind`text-white mb-2 ml-1 text-[17px] font-normal`}>
        {label}
      </Text>
      <TextInput
      ...
      <View style={tailwind`w-full flex flex-row justify-between items-end`}>
        <Pressable onPress={onPress}>
          <Text
            style={tailwind`ml-2 text-[#00A859] text-[15px] mt-1 font-normal ${hidden}`}
          >
            Forgot password?
          </Text>
        </Pressable>
        ...
        <Pressable onPress={togglePasswordVisibility}>
          <Text
            style={tailwind`mr-2 text-[#00A859] text-[15px] mt-1 font-normal`}
          >
