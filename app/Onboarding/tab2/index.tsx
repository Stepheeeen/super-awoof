...
const Onboarding = () => {
    ...
    return (
        <View style={tailwind`h-full w-full flex flex-col items-center justify-between py-[40px] px-1 bg-[#0F1219]`}>
            <Image source={require('../../../assets/images/coins.png')} style={tailwind`w-[95%] rounded-lg`} />
            ...
            <View style={tailwind`flex items-center px-3 mt-[-60px]`}>
                ...
                <Text style={tailwind`text-center text-[16px] font-[500] text-white leading-[23px]`}>Deposit as little as N1000 to get 400 coins and start spinning. Get ready for thrilling gameplay and cash rewards</Text>
            </View>
