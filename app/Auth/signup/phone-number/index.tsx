import { Pressable, ScrollView, Text, Animated, View, Dimensions, Alert } from "react-native";
...
const Index = ({ duration = 15000 }) => {
    ...
    const apiUrl = 'https://super-awoof-d6b48f0a17a5.herokuapp.com/api/v1/account/register';
